...
import latest5 from '../assets/latest/image1.png'
import latest6 from '../assets/latest/image2.png'
import latest7 from '../assets/latest/image3.png'
        ...
        <div className="about-content-wrapper">
          ...
          <div className="about-text-content">
            ...
            <h2 className="about-main-title">
              We are an <span className="about-creative">architectural</span> and <span className='about-creative'> Construction</span> - Company
            </h2>
            <p className="about-description">
              At Kulkarni Housing we build more than homes, we build communities where luxury meets convenience, affordability, and above all, trust. When you choose Kulkarni Housing is a Construction and Architectural firm, you choose our unwavering commitment to quality and customer service.
            </p>
            <p className="about-description">
